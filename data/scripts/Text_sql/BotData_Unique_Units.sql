drop table if exists BotData_Unique_Units;
create table BotData_Unique_Units ("这行建表语句用于清除库中对表结构的缓存记忆，以防出现N/A类型字段");
drop table if exists BotData_Unique_Units;
create table BotData_Unique_Units(
  Civilization TEXT,
  Owner TEXT,
  Unitname TEXT,
  BaseSightRange INT,
...
insert into BotData_Unique_Units
select
