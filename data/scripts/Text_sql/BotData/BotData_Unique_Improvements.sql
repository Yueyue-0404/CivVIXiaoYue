drop table if exists BotData_Unique_Improvements;
create table BotData_Unique_Improvements(id int);
drop table if exists BotData_Unique_Improvements;
CREATE TABLE if not exists BotData_Unique_Improvements(
  Civilization TEXT,
  Owner TEXT,
...
insert into BotData_Unique_Improvements
select
