drop table if exists BotData_Unique_Buildings;
create table if not exists BotData_Unique_Buildings(id int);
drop table if exists BotData_Unique_Buildings;
CREATE TABLE BotData_Unique_Buildings(
  Civilization TEXT,
  Owner TEXT,
  Name TEXT,
  Prereq TEXT,
...
insert into BotData_Unique_Buildings
select 
