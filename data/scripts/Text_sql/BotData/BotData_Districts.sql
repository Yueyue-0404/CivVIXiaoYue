drop table if exists BotData_Districts;
CREATE TABLE if not exists BotData_Districts(id int);
drop table if exists BotData_Districts;
CREATE TABLE if not exists BotData_Districts(
  Civilization TEXT,
  Owner TEXT,
  DistrictName TEXT,
  DistrictType TEXT,
